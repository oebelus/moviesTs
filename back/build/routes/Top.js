...
router.post('/:userId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingMovie = yield Top.findOne({
            where: { title, humanId: userId }
        });
        if (existingMovie) {
            return res.status(400).json({ error: "Bad Request", message: "Movie already in your watchlist." });
        }
        const watchedMovie = yield Top.create({ humanId: userId, title, year, runtime, type, poster });
...
router.delete('/:userId/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const movieToDelete = yield Top.findByPk(movieId);
        if (!movieToDelete)
...
router.get('/:userId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.params.userId;
        const listOfWatched = yield Top.findAll({ where: { humanId: userId } });
