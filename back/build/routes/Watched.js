...
router.post('/:userId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingMovie = yield Watched.findOne({
            where: { title, humanId: userId }
        });
        if (existingMovie) {
            return res.status(400).json({ error: "Bad Request", message: "Movie already exists in Watched" });
        }
        const watchedMovie = yield Watched.create({ humanId: userId, title, year, runtime, type, poster });
...
router.delete('/:userId/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const movieToDelete = yield Watched.findByPk(movieId);
        if (!movieToDelete)
...
router.get('/:userId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.params.userId;
        const listOfWatched = yield Watched.findAll({ where: { humanId: userId } });
